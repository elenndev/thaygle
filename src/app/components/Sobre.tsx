...
const Sobre = () => {
    return(<>
        <section id="sobre" className="sobre relative flex overflow-x-hidden flex-col items-center justify-center h-screen w-full bg-[--devScheme-orange] text-[--devScheme-white]">
            <h2 className="text-[--devScheme-white] text-[2.5rem] mb-[10px] font-gothic font-medium uppercase tracking-widest text-center">Sobre</h2>
            ...
            <h3 className="w-full text-[1.5rem] text-center font-medium">Redes sociais:</h3>
